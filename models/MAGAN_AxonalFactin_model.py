...
class MAGANAxonalFactinModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.set_defaults(norm='batch', netG='ST-Net', dataset_mode='axons', netS='resnet_6blocks', batch_size=8, crop_size=128, preprocess='crop_rotation', name='TAGANAxonalFactin_ST-Net_{}'.format(datetime.date.today()))
        if is_train:
