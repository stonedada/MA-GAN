...
class MAGANDendritesModel(BaseModel):
    """ This class implements the MA-GAN model for confocal to STED resolution enhancement for the dendritic F-actin rings and fibers dataset.
